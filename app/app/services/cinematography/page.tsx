  ...
  return (
    <div className="min-h-screen bg-white pt-32">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#232323] mb-6">Cinematic Storytelling</h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#b48b3c] mb-2">4K</div>
                  <div className="text-gray-600">Ultra HD Quality</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#b48b3c] mb-2">7-14</div>
      ...
      <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-[#232323] mb-12">Our Cinematography Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#232323]">Wedding Films</h3>
              <p className="text-gray-600">Cinematic wedding videos that capture the emotion and beauty of your special day.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#232323]">Event Videos</h3>
              <p className="text-gray-600">Professional event coverage for corporate functions, parties, and special occasions.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#232323]">Music Videos</h3>
              <p className="text-gray-600">Creative music video production with artistic direction and professional editing.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#232323]">Corporate Videos</h3>
              <p className="text-gray-600">Professional corporate video production for marketing, training, and brand promotion.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#232323]">Drone Footage</h3>
              <p className="text-gray-600">Aerial cinematography with drone technology for stunning overhead perspectives.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">Expert video editing with color grading, sound design, and cinematic effects.</p>
            </div>
          </div>
        </div>
      </section>
